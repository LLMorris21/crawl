...
{CMD_SAFE_WAIT, "CMD_SAFE_WAIT"},
{CMD_SAFE_MOVE_LEFT, "CMD_SAFE_MOVE_LEFT"},
{CMD_SAFE_MOVE_DOWN, "CMD_SAFE_MOVE_DOWN"},
{CMD_SAFE_MOVE_UP, "CMD_SAFE_MOVE_UP"},
{CMD_SAFE_MOVE_RIGHT, "CMD_SAFE_MOVE_RIGHT"},
{CMD_SAFE_MOVE_UP_LEFT, "CMD_SAFE_MOVE_UP_LEFT"},
{CMD_SAFE_MOVE_DOWN_LEFT, "CMD_SAFE_MOVE_DOWN_LEFT"},
{CMD_SAFE_MOVE_UP_RIGHT, "CMD_SAFE_MOVE_UP_RIGHT"},
{CMD_SAFE_MOVE_DOWN_RIGHT, "CMD_SAFE_MOVE_DOWN_RIGHT"},
{CMD_ATTACK_LEFT, "CMD_ATTACK_LEFT"},
{CMD_ATTACK_DOWN, "CMD_ATTACK_DOWN"},
{CMD_ATTACK_UP, "CMD_ATTACK_UP"},
{CMD_ATTACK_RIGHT, "CMD_ATTACK_RIGHT"},
{CMD_ATTACK_UP_LEFT, "CMD_ATTACK_UP_LEFT"},
{CMD_ATTACK_DOWN_LEFT, "CMD_ATTACK_DOWN_LEFT"},
{CMD_ATTACK_UP_RIGHT, "CMD_ATTACK_UP_RIGHT"},
{CMD_ATTACK_DOWN_RIGHT, "CMD_ATTACK_DOWN_RIGHT"},
{CMD_PRIMARY_ATTACK, "CMD_PRIMARY_ATTACK"},
{CMD_OPEN_DOOR, "CMD_OPEN_DOOR"},
{CMD_CLOSE_DOOR_LEFT, "CMD_CLOSE_DOOR_LEFT"},
{CMD_CLOSE_DOOR_DOWN, "CMD_CLOSE_DOOR_DOWN"},
{CMD_CLOSE_DOOR_UP, "CMD_CLOSE_DOOR_UP"},
{CMD_CLOSE_DOOR_RIGHT, "CMD_CLOSE_DOOR_RIGHT"},
{CMD_CLOSE_DOOR_UP_LEFT, "CMD_CLOSE_DOOR_UP_LEFT"},
{CMD_CLOSE_DOOR_DOWN_LEFT, "CMD_CLOSE_DOOR_DOWN_LEFT"},
{CMD_CLOSE_DOOR_UP_RIGHT, "CMD_CLOSE_DOOR_UP_RIGHT"},
{CMD_CLOSE_DOOR_DOWN_RIGHT, "CMD_CLOSE_DOOR_DOWN_RIGHT"},
...
{CMD_TOGGLE_SOUND, "CMD_TOGGLE_SOUND"},
{CMD_TOGGLE_TRAVEL_SPEED, "CMD_TOGGLE_TRAVEL_SPEED"},
{CMD_PICKUP, "CMD_PICKUP"},
{CMD_PICKUP_QUANTITY, "CMD_PICKUP_QUANTITY"},
{CMD_DROP, "CMD_DROP"},
{CMD_DROP_LAST, "CMD_DROP_LAST"},
{CMD_INSPECT_FLOOR, "CMD_INSPECT_FLOOR"},
{CMD_SHOW_TERRAIN, "CMD_SHOW_TERRAIN"},
{CMD_FULL_VIEW, "CMD_FULL_VIEW"},
{CMD_EVOKE, "CMD_EVOKE"},
{CMD_EVOKE_WIELDED, "CMD_EVOKE_WIELDED"},
{CMD_FORCE_EVOKE_WIELDED, "CMD_FORCE_EVOKE_WIELDED"},
...
{CMD_EXPLORE_MODE, "CMD_EXPLORE_MODE"},
...
{CMD_AUTOFIGHT, "CMD_AUTOFIGHT"},
{CMD_AUTOFIGHT_NOMOVE, "CMD_AUTOFIGHT_NOMOVE"},
...
#endif
#ifdef TOUCH_UI
{CMD_SHOW_KEYBOARD, "CMD_SHOW_KEYBOARD"},
#endif
{CMD_PREV_CMD_AGAIN, "CMD_PREV_CMD_AGAIN"},
{CMD_REPEAT_CMD, "CMD_REPEAT_CMD"},
{CMD_LUA_CONSOLE, "CMD_LUA_CONSOLE"},
{CMD_SET_SKILL_TARGET, "CMD_SET_SKILL_TARGET"},
...
{CMD_MAP_EXPLORE, "CMD_MAP_EXPLORE"},
{CMD_MAP_WIZARD_TELEPORT, "CMD_MAP_WIZARD_TELEPORT"},
{CMD_MAP_WIZARD_FORGET, "CMD_MAP_WIZARD_FORGET"},
{CMD_MAP_DESCRIBE, "CMD_MAP_DESCRIBE"},
{CMD_MAP_HELP, "CMD_MAP_HELP"},
{CMD_MAP_FORGET, "CMD_MAP_FORGET"},
{CMD_MAP_UNFORGET, "CMD_MAP_UNFORGET"},
#ifdef USE_TILE
{CMD_MAP_ZOOM_IN, "CMD_MAP_ZOOM_IN"},
{CMD_MAP_ZOOM_OUT, "CMD_MAP_ZOOM_OUT"},
#endif
...
{CMD_TARGET_FULL_DESCRIBE, "CMD_TARGET_FULL_DESCRIBE"},
...
{CMD_TARGET_EXCLUDE, "CMD_TARGET_EXCLUDE"},
...
{CMD_TARGET_CYCLE_QUIVER_BACKWARD, "CMD_TARGET_CYCLE_QUIVER_BACKWARD"},
{CMD_TARGET_CYCLE_QUIVER_FORWARD, "CMD_TARGET_CYCLE_QUIVER_FORWARD"},
{CMD_TARGET_SELECT_ACTION, "CMD_TARGET_SELECT_ACTION"},
...
{CMD_TARGET_WIZARD_HEAL_MONSTER, "CMD_TARGET_WIZARD_HEAL_MONSTER"},
{CMD_TARGET_WIZARD_HURT_MONSTER, "CMD_TARGET_WIZARD_HURT_MONSTER"},
{CMD_TARGET_WIZARD_DEBUG_PORTAL, "CMD_TARGET_WIZARD_DEBUG_PORTAL"},
{CMD_TARGET_WIZARD_KILL_MONSTER, "CMD_TARGET_WIZARD_KILL_MONSTER"},
{CMD_TARGET_WIZARD_BANISH_MONSTER, "CMD_TARGET_WIZARD_BANISH_MONSTER"},
{CMD_TARGET_WIZARD_CREATE_MIMIC, "CMD_TARGET_WIZARD_CREATE_MIMIC"},
...
#ifdef USE_TILE
{CMD_DOLL_RANDOMIZE, "CMD_DOLL_RANDOMIZE"},
{CMD_DOLL_SELECT_NEXT_DOLL, "CMD_DOLL_SELECT_NEXT_DOLL"},
{CMD_DOLL_SELECT_PREV_DOLL, "CMD_DOLL_SELECT_PREV_DOLL"},
{CMD_DOLL_SELECT_NEXT_PART, "CMD_DOLL_SELECT_NEXT_PART"},
{CMD_DOLL_SELECT_PREV_PART, "CMD_DOLL_SELECT_PREV_PART"},
{CMD_DOLL_CHANGE_PART_NEXT, "CMD_DOLL_CHANGE_PART_NEXT"},
{CMD_DOLL_CHANGE_PART_PREV, "CMD_DOLL_CHANGE_PART_PREV"},
{CMD_DOLL_CONFIRM_CHOICE, "CMD_DOLL_CONFIRM_CHOICE"},
{CMD_DOLL_COPY, "CMD_DOLL_COPY"},
{CMD_DOLL_PASTE, "CMD_DOLL_PASTE"},
{CMD_DOLL_TAKE_OFF, "CMD_DOLL_TAKE_OFF"},
{CMD_DOLL_TAKE_OFF_ALL, "CMD_DOLL_TAKE_OFF_ALL"},
{CMD_DOLL_TOGGLE_EQUIP, "CMD_DOLL_TOGGLE_EQUIP"},
{CMD_DOLL_TOGGLE_EQUIP_ALL, "CMD_DOLL_TOGGLE_EQUIP_ALL"},
{CMD_DOLL_JOB_DEFAULT, "CMD_DOLL_JOB_DEFAULT"},
{CMD_DOLL_CHANGE_MODE, "CMD_DOLL_CHANGE_MODE"},
{CMD_DOLL_SAVE, "CMD_DOLL_SAVE"},
{CMD_DOLL_QUIT, "CMD_DOLL_QUIT"},
#endif
